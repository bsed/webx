 ...
 * <li>{@link ArrayUtils#getLast(Object[], Object, Object, boolean)}
 * 得到array中某个元素（从前到后第一次匹配）的前一个元素</li>
 * <li>{@link ArrayUtils#getNext(Object[], Object, Object, boolean)}
 * 得到array中某个元素（从前到后第一次匹配）的后一个元素</li>
 * </ul>
 * 
 * @author kelvin
 *
...
public class ArrayUtil extends org.apache.commons.lang3.ArrayUtils {
	...
	public static <V> V getNext(V[] sourceArray, V value, V defaultValue, boolean isCircle) {
		...
		int currentPosition = -1;
		for (int i = 0; i < sourceArray.length; i++) {
			if (ObjectUtil.isEquals(value, sourceArray)) {
				currentPosition = i;
				break;
			}
		}
